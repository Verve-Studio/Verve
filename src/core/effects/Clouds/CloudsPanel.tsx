...
import type { CloudsEffectLayer } from "@/core/effects/Clouds/CloudsEffect";
    ...
    <div className={styles.content}>
      <div className={styles.row}>
        ...
        <div className={styles.trackWrap}>
          <input
            ...
            value={scale}
            style={
              { "--pct": String((scale - 1) / 999) } as React.CSSProperties
            }
        ...
        <input
          ...
          onChange={(e) => {
            ...
            if (!isNaN(v))
              up({ scale: Math.min(1000, Math.max(1, Math.round(v))) });
          }}
        />
      ...
      <div className={styles.row}>
        ...
        <input
          ...
          onChange={(e) => {
            const v = e.target.valueAsNumber;
            if (!isNaN(v))
              up({ opacity: Math.min(100, Math.max(0, Math.round(v))) });
          }}
        />
      ...
      <div className={styles.row}>
        ...
        <div className={styles.segmented}>
          {(["grayscale", "color"] as const).map((m) => (
            <button
              key={m}
              className={`${styles.segBtn} ${colorMode === m ? styles.segBtnActive : ""}`}
              onClick={() => up({ colorMode: m })}
            >
        ...
        <>
          <div className={styles.row}>
            ...
            <div
              ...
              style={{ backgroundColor: `rgb(${fgR},${fgG},${fgB})` }}
              title={`rgb(${fgR}, ${fgG}, ${fgB})`}
            />
            <span className={styles.unitSpacer} />
          </div>
          <div className={styles.row}>
      ...
      <div className={styles.footer}>
        ...
        <button
          ...
          onClick={() =>
            up({ scale: 50, opacity: 100, colorMode: "grayscale" })
          }
          title="Reset"
        >
          Reset
