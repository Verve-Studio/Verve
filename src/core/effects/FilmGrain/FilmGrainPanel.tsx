...
export function FilmGrainPanel({
  layer,
  parentLayerName,
    ...
    <div className={styles.content}>
      <div className={styles.row}>
        ...
        <div className={styles.trackWrap}>
          <input
            ...
            value={grainSize}
            style={
              { "--pct": String((grainSize - 1) / 99) } as React.CSSProperties
            }
        ...
        <input
          ...
          onChange={(e) => {
            ...
            if (!isNaN(v))
              up({ grainSize: Math.min(100, Math.max(1, Math.round(v))) });
          }}
        />
      ...
      <div className={styles.row}>
        ...
        <div className={styles.trackWrap}>
          <input
            ...
            value={intensity}
            style={
              { "--pct": String((intensity - 1) / 199) } as React.CSSProperties
            }
        ...
        <input
          ...
          onChange={(e) => {
            const v = e.target.valueAsNumber;
            if (!isNaN(v))
              up({ intensity: Math.min(200, Math.max(1, Math.round(v))) });
          }}
        />
        <span className={styles.unitSpacer} />
      </div>
      <div className={styles.row}>
        ...
        <div className={styles.trackWrap}>
          <input
            ...
            step={1}
            value={roughness}
            style={{ "--pct": String(roughness / 100) } as React.CSSProperties}
        ...
        <input
          ...
          onChange={(e) => {
            const v = e.target.valueAsNumber;
            if (!isNaN(v))
              up({ roughness: Math.min(100, Math.max(0, Math.round(v))) });
          }}
        />
      ...
      <div className={styles.footer}>
        ...
        <button
          ...
          onClick={() => up({ grainSize: 5, intensity: 35, roughness: 50 })}
          title="Reset"
        >
          Reset
        </button>
