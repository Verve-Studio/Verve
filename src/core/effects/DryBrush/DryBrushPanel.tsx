...
import type { DryBrushEffectLayer } from "./DryBrushEffect";
import { ParentConnectorIcon } from "@/ux/windows/ToolWindowIcons";
import styles from "@/core/effects/_shared/filterPanel.module.scss";

interface Props {
  layer: DryBrushEffectLayer;
  parentLayerName: string;
}

export function DryBrushPanel({
  layer,
  parentLayerName,
  ...
  const update = (patch: Partial<DryBrushEffectLayer["params"]>): void => {
    dispatch({
    ...
    <div className={styles.content}>
      ...
      <div className={styles.footer}>
        ...
        <button
          ...
          onClick={() => update({ brushSize: 2, brushDetail: 8, texture: 1 })}
        >
          Reset
        </button>
      </div>
