...
export interface AdjustmentRegistrationEntry<
  T extends AdjustmentType = AdjustmentType,
> {
  adjustmentType: T;
  label: string;
...
export const ADJUSTMENT_REGISTRY = [
  ...
  {
    adjustmentType: "polar-coordinates" as const,
    label: "Polar Coordinates…",
    group: "real-time-effects",
    menuGroup: "fx-distortion",
    defaultParams: {
      mode: "rect-to-polar" as const,
      centerX: 0.5,
      centerY: 0.5,
      edgeMode: "transparent" as const,
    },
  ...
  {
    adjustmentType: "ripple" as const,
    label: "Ripple…",
    group: "real-time-effects",
    menuGroup: "fx-distortion",
    defaultParams: {
  ...
  {
    adjustmentType: "displace" as const,
    label: "Displace…",
    group: "real-time-effects",
    menuGroup: "fx-distortion",
    defaultParams: {
  ...
  {
    adjustmentType: "offset" as const,
    label: "Offset…",
    group: "filters",
