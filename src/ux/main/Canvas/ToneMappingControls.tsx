...
export function ToneMappingControls({ pixelFormat }: ToneMappingControlsProps): React.JSX.Element | null {
  const [ev, setEv] = useState(displayStore.exposureEV)
  const [operator, setOperator] = useState<ToneMappingOperator>(displayStore.toneMappingOperator)
