...
export interface MainWindowProps {
  ...
  // Dialog state
  showNewImageDialog: boolean;      setShowNewImageDialog:      (v: boolean) => void
  showExportDialog: boolean;        setShowExportDialog:        (v: boolean) => void
  ...
  pendingConversion: PixelFormat | null; setPendingConversion: (v: PixelFormat | null) => void
...
export function MainWindow(props: MainWindowProps): React.JSX.Element {
  const {
    ...
    showContentAwareFillOptionsDialog, setShowContentAwareFillOptionsDialog, contentAwareFillOptionsMode,
  ...
  return (
    <div className={styles.app}>
      <TopBar
        ...
        onRasterizeLayer={activeLayerId ? () => handleRasterizeLayer(activeLayerId) : undefined}
