...
function toolTitle(layer: AdjustmentLayerState): string {
  switch (layer.adjustmentType) {
    ...
    case "motion-blur":
      return "Motion Blur";
    case "remove-motion-blur":
      return "Remove Motion Blur";
    case "lens-blur":
      return "Lens Blur";
    case "sharpen":
      return "Sharpen";
      ...
      >
        {adjLayer.adjustmentType === "brightness-contrast" && (
          <BrightnessContrastPanel
            layer={adjLayer as BrightnessContrastAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "hue-saturation" && (
          <HueSaturationPanel
            layer={adjLayer as HueSaturationAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "color-vibrance" && (
          <ColorVibrancePanel
            layer={adjLayer as ColorVibranceAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "color-balance" && (
          <ColorBalancePanel
            layer={adjLayer as ColorBalanceAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "black-and-white" && (
          <BlackAndWhitePanel
            layer={adjLayer as BlackAndWhiteAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "color-temperature" && (
          <ColorTemperaturePanel
            layer={adjLayer as ColorTemperatureAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "color-invert" && (
          <InvertPanel
            layer={adjLayer as ColorInvertAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        ...
        {adjLayer.adjustmentType === "bloom" && (
          <BloomOptions
            layer={adjLayer as BloomAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        ...
        {adjLayer.adjustmentType === "gaussian-blur" && (
          <GaussianBlurPanel
            layer={adjLayer as GaussianBlurAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "box-blur" && (
          <BoxBlurPanel
            layer={adjLayer as BoxBlurAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "radial-blur" && (
          <RadialBlurPanel
            layer={adjLayer as RadialBlurAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "motion-blur" && (
          <MotionBlurPanel
            layer={adjLayer as MotionBlurAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "remove-motion-blur" && (
          <RemoveMotionBlurPanel
            layer={adjLayer as RemoveMotionBlurAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "lens-blur" && (
          <LensBlurPanel
            layer={adjLayer as LensBlurAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "sharpen" && (
          <SharpenPanel
            layer={adjLayer as SharpenAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "sharpen-more" && (
          <SharpenPanel
            layer={adjLayer as SharpenMoreAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "unsharp-mask" && (
          <UnsharpMaskPanel
            layer={adjLayer as UnsharpMaskAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "smart-sharpen" && (
          <SmartSharpenPanel
            layer={adjLayer as SmartSharpenAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "add-noise" && (
          <AddNoisePanel
            layer={adjLayer as AddNoiseAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "film-grain" && (
          <FilmGrainPanel
            layer={adjLayer as FilmGrainAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "median-filter" && (
          <MedianFilterPanel
            layer={adjLayer as MedianFilterAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "bilateral-filter" && (
          <BilateralFilterPanel
            layer={adjLayer as BilateralFilterAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "reduce-noise" && (
          <ReduceNoisePanel
            layer={adjLayer as ReduceNoiseAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "clouds" && (
          <CloudsPanel
            layer={adjLayer as CloudsAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "pixelate" && (
          <PixelatePanel
            layer={adjLayer as PixelateAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "bevel" && (
          <BevelOptions
            layer={adjLayer as BevelAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "inner-shadow" && (
          <InnerShadowOptions
            layer={adjLayer as InnerShadowAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
        {adjLayer.adjustmentType === "inner-glow" && (
          <InnerGlowOptions
            layer={adjLayer as InnerGlowAdjustmentLayer}
            parentLayerName={parentLayerName}
          />
        )}
