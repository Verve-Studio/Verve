...
export function MedianFilterPanel({
  layer,
  parentLayerName,
  ...
  return (
    <div className={styles.content}>
      <div className={styles.row}>
        ...
        <div className={styles.trackWrap}>
          <input
            ...
            step={1}
            value={radius}
            style={{ "--pct": String((radius - 1) / 9) } as React.CSSProperties}
        ...
        <input
          ...
          onChange={(e) => {
            ...
            if (!isNaN(v)) up(Math.min(10, Math.max(1, Math.round(v))));
          }}
        />
      ...
      <div className={styles.footer}>
        ...
        <button className={styles.resetBtn} onClick={() => up(1)} title="Reset">
          Reset
        </button>
      </div>
    </div>
