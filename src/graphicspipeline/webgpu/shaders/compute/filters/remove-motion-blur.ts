...
import FILTER_RMB_PSF_COMPUTE from './wgsl/filter-rmb-psf.wgsl?raw'
...
import FILTER_RMB_RATIO_COMPUTE from './wgsl/filter-rmb-ratio.wgsl?raw'
...
import FILTER_RMB_UPDATE_COMPUTE from './wgsl/filter-rmb-update.wgsl?raw'
...
import FILTER_RMB_FINAL_COMPUTE from './wgsl/filter-rmb-final.wgsl?raw'
