...
class FilterComputeEngine {
  ...
  async gaussianBlur(
    ...
    return runGaussianBlur(
      this.device,
      this.gaussianHPipeline.s8,
      this.gaussianVPipeline.s8,
      pixels,
      width,
      height,
      radius,
  ...
  async boxBlur(
    ...
    return runBoxBlur(
      this.device,
      this.boxHPipeline.s8,
      this.boxVPipeline.s8,
      pixels,
      width,
      height,
      radius,
  ...
  async radialBlur(
    ...
    return runRadialBlur(
      this.device,
      this.radialBlurPipeline.s8,
      pixels,
      width,
      height,
      mode,
  ...
  async motionBlur(
    ...
    return runMotionBlur(
      this.device,
      this.motionBlurPipeline.s8,
      pixels,
      width,
      height,
      angleDeg,
  ...
  async lensBlur(
    ...
    return runLensBlur(
      this.device,
      this.lensBlurPipeline.s8,
      pixels,
      width,
      height,
      this.cachedKernelBuf!,
      this.cachedKernelCount,
    );
  }
  ...
  async sharpenMore(
    ...
    return runSharpenMore(
      this.device,
      this.sharpenMorePipeline.s8,
      pixels,
      width,
      height,
    );
  ...
  async unsharpMask(
    ...
    return runUnsharpMask(
      this.device,
      this.gaussianHPipeline.s8,
      this.gaussianVPipeline.s8,
      this.unsharpCombinePipeline.s8,
      pixels,
      width,
      height,
      amount,
  ...
  async smartSharpen(
    ...
    return runSmartSharpen(
      this.device,
      this.gaussianHPipeline.s8,
      this.gaussianVPipeline.s8,
      this.boxHPipeline.s8,
      this.boxVPipeline.s8,
      this.smartSharpenGaussCombinePipeline.s8,
      this.smartSharpenLensPipeline.s8,
      this.smartSharpenBlendPipeline.s8,
      pixels,
      width,
      height,
      amount,
  ...
  async filmGrain(
    ...
    return runFilmGrain(
      this.device,
      this.filmGrainNoisePipeline,
      this.filmGrainCombinePipeline.s8,
      this.boxHPipeline.s8,
      this.boxVPipeline.s8,
      pixels,
      width,
  ...
  async reduceNoise(
    ...
    return runReduceNoise(
      this.device,
      this.reduceNoisePipeline.s8,
      pixels,
      width,
      height,
      strength,
  ...
  encodeGaussianBlur(
    ...
    this.encodeRenderPass(
      encoder,
      this.selectPipeline(this.gaussianHPipeline, this.intermediate0),
      [
    ...
    this.encodeRenderPass(
      encoder,
      this.selectPipeline(this.gaussianVPipeline, dstTex),
      [
  ...
  encodeBoxBlur(
    ...
    this.encodeRenderPass(
      encoder,
      this.selectPipeline(this.boxHPipeline, this.intermediate0),
      [
        { binding: 0, resource: srcTex.createView() },
        { binding: 2, resource: { buffer: paramsBuf } },
      ],
    ...
    this.encodeRenderPass(
      encoder,
      this.selectPipeline(this.boxVPipeline, dstTex),
      [
        { binding: 0, resource: this.intermediate0.createView() },
        { binding: 2, resource: { buffer: paramsBuf } },
      ],
  ...
  encodeRadialBlur(
    ...
    this.encodeRenderPass(
      encoder,
      this.selectPipeline(this.radialBlurPipeline, dstTex),
      [
        { binding: 0, resource: srcTex.createView() },
        { binding: 2, resource: { buffer: paramsBuf } },
      ],
  ...
  encodeMotionBlur(
    ...
    this.encodeRenderPass(
      encoder,
      this.selectPipeline(this.motionBlurPipeline, dstTex),
      [
        { binding: 0, resource: srcTex.createView() },
        { binding: 2, resource: { buffer: paramsBuf } },
      ],
  ...
  encodeRemoveMotionBlur(
    ...
    this.encodeRenderPass(
      encoder,
      this.selectPipeline(this.rmbFinalPipeline, dstTex),
      [
        { binding: 0, resource: curEst.createView() },
  ...
  encodeLensBlur(
    ...
    const paramsBuf = this.makeParamsBuf(
      new Uint32Array([this.cachedKernelCount, 0, 0, 0]),
    );
    this.encodeRenderPass(
      encoder,
      this.selectPipeline(this.lensBlurPipeline, dstTex),
      [
        { binding: 0, resource: srcTex.createView() },
        { binding: 2, resource: { buffer: paramsBuf } },
  ...
  encodeSharpen(
    ...
    this.encodeRenderPass(
      encoder,
      this.selectPipeline(this.sharpenPipeline, dstTex),
      [{ binding: 0, resource: srcTex.createView() }],
      dstTex,
    );
  }
  ...
  encodeSharpenMore(
    ...
    this.encodeRenderPass(
      encoder,
      this.selectPipeline(this.sharpenMorePipeline, dstTex),
      [{ binding: 0, resource: srcTex.createView() }],
      dstTex,
    );
  }
  ...
  encodeUnsharpMask(
    ...
    const gaussParamsBuf = this.makeParamsBuf(
    ...
    const combineParamsBuf = this.makeParamsBuf(
      new Uint32Array([amount, threshold, 0, 0]),
    );
    this.encodeRenderPass(
      encoder,
      this.selectPipeline(this.unsharpCombinePipeline, dstTex),
      [
        { binding: 0, resource: srcTex.createView() },
  ...
  encodeSmartSharpen(
    ...
    if (remove === 0) {
      ...
      if (reduceNoise > 0) {
        ...
        const blendParamsBuf = this.makeParamsBuf(
          new Uint32Array([reduceNoise, 0, 0, 0]),
        );
        this.encodeRenderPass(
          encoder,
          this.selectPipeline(this.smartSharpenBlendPipeline, dstTex),
          [
            { binding: 0, resource: sharpenedTex.createView() },
        ...
        this.encodeRenderPass(
          encoder,
          this.selectPipeline(this.smartSharpenGaussCombinePipeline, dstTex),
          [
            { binding: 0, resource: srcTex.createView() },
            { binding: 2, resource: blurredTex.createView() },
            { binding: 3, resource: { buffer: combineParamsBuf } },
      ...
      if (reduceNoise > 0) {
        const sharpenedTex = this.makeRgba8Tex(w, h);
        const lensParamsBuf = this.makeParamsBuf(
          new Uint32Array([amount, 0, 0, 0]),
        );
        this.encodeRenderPass(
          encoder,
        ...
        this.encodeRenderPass(
          encoder,
          this.selectPipeline(this.smartSharpenLensPipeline, dstTex),
          [
            { binding: 0, resource: srcTex.createView() },
            { binding: 2, resource: { buffer: lensParamsBuf } },
          ],
  ...
  encodeAddNoise(
    ...
    const paramsBuf = this.makeParamsBuf(
      new Uint32Array([amount, distribution, monochromatic, seed]),
    );
    this.encodeRenderPass(
      encoder,
      this.selectPipeline(this.addNoisePipeline, dstTex),
      [
        { binding: 0, resource: srcTex.createView() },
        { binding: 2, resource: { buffer: paramsBuf } },
      ],
  ...
  encodeFilmGrain(
    ...
    if (blurRadius > 0) {
      ...
      const blurParamsBuf = this.makeParamsBuf(
    ...
    this.encodeRenderPass(
      encoder,
      this.selectPipeline(this.filmGrainCombinePipeline, dstTex),
      [
        { binding: 0, resource: srcTex.createView() },
  ...
  encodeMedian(
    ...
    this.encodeRenderPass(
      encoder,
      this.selectPipeline(this.medianPipeline, dstTex),
      [
        { binding: 0, resource: srcTex.createView() },
        { binding: 2, resource: { buffer: paramsBuf } },
      ],
  ...
  encodeBilateral(
    ...
    this.encodeRenderPass(
      encoder,
      this.selectPipeline(this.bilateralPipeline, dstTex),
      [
        { binding: 0, resource: srcTex.createView() },
        { binding: 2, resource: { buffer: paramsBuf } },
      ],
  ...
  encodeReduceNoise(
    ...
    if (sharpenDetails > 0) {
      ...
      const rndParamsBuf = this.makeParamsBuf(
      ...
      const unsharpParamsBuf = this.makeParamsBuf(
      ...
      this.encodeRenderPass(
        encoder,
        this.selectPipeline(this.reduceNoisePipeline, dstTex),
        [
          { binding: 0, resource: srcTex.createView() },
          { binding: 2, resource: { buffer: rndParamsBuf } },
        ],
  ...
  encodeClouds(
    ...
    const permBuf = this.device.createBuffer({
    ...
    this.encodeRenderPass(
      encoder,
      this.selectPipeline(this.cloudsPipeline, dstTex),
      [
        { binding: 0, resource: srcTex.createView() },
        { binding: 2, resource: { buffer: paramsBuf } },
  ...
  encodePixelate(
    ...
    this.encodeRenderPass(
      encoder,
      this.selectPipeline(this.pixelatePipeline, dstTex),
      [
        { binding: 0, resource: srcTex.createView() },
        { binding: 2, resource: { buffer: paramsBuf } },
      ],
  ...
  encodeSeamlessTexture(
    ...
    if (!breakRepetition && !seamlessBorders) {
      this.encodeRenderPass(
        encoder,
        this.selectPipeline(this.seamlessBorderPipeline, dstTex),
        [
          { binding: 0, resource: srcTex.createView() },
          {
            binding: 2,
            resource: {
              buffer: this.makeParamsBuf(new Uint32Array([w, h, 0, 0])),
            },
          },
        ],
        dstTex,
    ...
    if (breakRepetition) {
      ...
      this.encodeRenderPass(
        encoder,
        this.selectPipeline(this.seamlessBreakPipeline, pass1Dst),
        [
          { binding: 0, resource: srcTex.createView() },
...
export function encodeGaussianBlur(
  encoder: GPUCommandEncoder,
  srcTex: GPUTexture,
  dstTex: GPUTexture,
  w: number,
  ...
  _engine!.encodeGaussianBlur(encoder, srcTex, dstTex, w, h, radius);
}
export function encodeBoxBlur(
  encoder: GPUCommandEncoder,
  srcTex: GPUTexture,
  dstTex: GPUTexture,
  w: number,
  ...
  _engine!.encodeBoxBlur(encoder, srcTex, dstTex, w, h, radius);
}
export function encodeRadialBlur(
  encoder: GPUCommandEncoder,
  srcTex: GPUTexture,
  dstTex: GPUTexture,
  w: number,
...
export function encodeMotionBlur(
  encoder: GPUCommandEncoder,
  srcTex: GPUTexture,
  dstTex: GPUTexture,
  w: number,
  ...
  _engine!.encodeMotionBlur(encoder, srcTex, dstTex, w, h, angle, distance);
}
export function encodeRemoveMotionBlur(
  encoder: GPUCommandEncoder,
  srcTex: GPUTexture,
  dstTex: GPUTexture,
  w: number,
  ...
  _engine!.encodeRemoveMotionBlur(
    encoder,
    srcTex,
    dstTex,
    w,
...
export function encodeLensBlur(
  encoder: GPUCommandEncoder,
  srcTex: GPUTexture,
  dstTex: GPUTexture,
  w: number,
...
export function encodeSharpen(
  ...
  _engine!.encodeSharpen(encoder, srcTex, dstTex, w, h);
}
export function encodeSharpenMore(
  encoder: GPUCommandEncoder,
  srcTex: GPUTexture,
  dstTex: GPUTexture,
  w: number,
  ...
  _engine!.encodeSharpenMore(encoder, srcTex, dstTex, w, h);
}
export function encodeUnsharpMask(
  encoder: GPUCommandEncoder,
  srcTex: GPUTexture,
  dstTex: GPUTexture,
  w: number,
...
export function encodeSmartSharpen(
  encoder: GPUCommandEncoder,
  srcTex: GPUTexture,
  dstTex: GPUTexture,
  w: number,
...
export function encodeAddNoise(
  encoder: GPUCommandEncoder,
  srcTex: GPUTexture,
  dstTex: GPUTexture,
  w: number,
...
export function encodeFilmGrain(
  encoder: GPUCommandEncoder,
  srcTex: GPUTexture,
  dstTex: GPUTexture,
  w: number,
...
export function encodeMedian(
  ...
  _engine!.encodeMedian(encoder, srcTex, dstTex, w, h, radius);
}
export function encodeBilateral(
  encoder: GPUCommandEncoder,
  srcTex: GPUTexture,
  dstTex: GPUTexture,
  w: number,
...
export function encodeReduceNoise(
  encoder: GPUCommandEncoder,
  srcTex: GPUTexture,
  dstTex: GPUTexture,
  w: number,
...
export function encodePixelate(
  encoder: GPUCommandEncoder,
  srcTex: GPUTexture,
  dstTex: GPUTexture,
  w: number,
